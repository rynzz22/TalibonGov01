...
-- Script: PRODUCTION_BOOTSTRAP.sql
-- Description: Run this script in the Supabase SQL Editor after applying
-- 20260803000000_v4_enterprise_municipal_core.sql to seed default roles,
-- permissions, departments, barangays, categories, tags, storage buckets,
-- and RLS policies.
-- ====================================================================
...
-- --------------------------------------------------------------------
-- 4.5. PROFILES ROW LEVEL SECURITY POLICIES
-- --------------------------------------------------------------------
...
-- --------------------------------------------------------------------
-- 5. STORAGE BUCKET INITIALIZATION & POLICIES
-- --------------------------------------------------------------------
...
SELECT 'Production Bootstrap Complete' AS status;
