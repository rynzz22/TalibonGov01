  ...
  const availableServices = [
    {
      ...
      icon: FileText,
      iconBg: "bg-sky-50 text-brand-primary dark:bg-sky-950/20 dark:text-brand-secondary",
      isInternal: true,
    },
    {
      id: "business" as ServiceType,
      title: "Business Permit",
      description: "Apply for a new business permit or renew existing licenses. Download templates and submit requests directly.",
